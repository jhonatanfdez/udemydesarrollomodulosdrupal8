...
class form_exampleController extends ControllerBase {
   ...
   */
   ...
   public function mostrarunregistro($arg) {
    ...
    //nueva forma
     $url = Url::fromUri($base_url.'/form_example/'.$arg.'/edit');
     $editar_link = render(Link::fromTextAndUrl(t('Editar registro'), $url)->toRenderable());
...
$database= \Drupal::database();
  ...
  foreach ($result as $row) {
    ...
    $ver_link = render(Link::fromTextAndUrl(t('Ver'), $url)->toRenderable());
    ...
    $editar_link = render(Link::fromTextAndUrl(t('Editar'), $url)->toRenderable());
    ...
    $eliminar_link = render(Link::fromTextAndUrl(t('Eliminar'), $url)->toRenderable());
